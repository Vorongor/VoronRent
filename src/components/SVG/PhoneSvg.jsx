// icon:telephone-inbound-fill | Bootstrap https://icons.getbootstrap.com/ | Bootstrap
import * as React from 'react';

function IconTelephoneInboundFill(props) {
  return (
    <svg fill="#3470ff" viewBox="0 0 16 16" height="2em" width="2em" {...props}>
      <path
        fillRule="evenodd"
...
export default IconTelephoneInboundFill;
